...
class ChessMatchmaker {
    ...
    createMatchmakingUI() {
        ...
        controlPanel.id = 'chess-matchmaking-panel';
        controlPanel.innerHTML = `
      <div class="matchmaking-controls">
        <button id="find-opponent" class="matchmaking-button">Find Human Opponent</button>
        <button id="play-ai" class="matchmaking-button">Play Against AI</button>
        <div id="matchmaking-status">Not searching</div>
      </div>
    `;
        ...
        // Add event listeners
        document.getElementById('find-opponent').addEventListener('click', () => this.toggleSearch());
        document.getElementById('play-ai').addEventListener('click', () => this.playAgainstAI());
    }
